...
<div class="text-center">
    <!-- Error Code -->
    <div class="mb-6">
        <h1 class="text-7xl font-bold text-zinc-200 dark:text-zinc-700 mb-3">500</h1>
        <div class="w-20 h-1 bg-gradient-to-r from-red-500 via-orange-500 to-yellow-500 mx-auto rounded-full"></div>
    </div>
